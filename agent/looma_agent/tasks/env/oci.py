...
from looma_agent.tasks.env.archive import BadArchive, apply_layer

logger = logging.getLogger("looma_agent.tasks.env.oci")

DEFAULT_REGISTRY = "registry-1.docker.io"
DEFAULT_TAG = "latest"
PULL_TIMEOUT_S = int(os.environ.get("LOOMA_OCI_TIMEOUT_S", "600"))
