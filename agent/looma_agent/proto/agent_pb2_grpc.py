...
class AgentGatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Attach = channel.stream_stream(
                '/looma.agent.v1.AgentGateway/Attach',
...
def add_AgentGatewayServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'looma.agent.v1.AgentGateway', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('looma.agent.v1.AgentGateway', rpc_method_handlers)
