...
logger = logging.getLogger("loom_agent.tasks.models")
...
DEFAULT_QUOTA_BYTES = int(os.environ.get("LOOM_MODEL_QUOTA_BYTES", str(128 * 1024**3)))
...
# загрузку стадии.
GRACE_S = float(os.environ.get("LOOM_MODEL_GRACE_S", str(3600)))
