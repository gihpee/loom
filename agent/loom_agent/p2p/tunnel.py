...
Всё остальное в Loom адресуется по РАНГУ и обходится сообщениями: задача шлёт
...
logger = logging.getLogger("loom_agent.p2p.tunnel")
...
MAX_CONNECTIONS = int(__import__("os").environ.get("LOOM_TUNNEL_MAX", "512"))
