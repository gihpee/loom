...
# Original: src/scheduling/model_info.py — ModelInfo with per-layer FLOPs / IO-bytes
# footprint estimation.
# Изменения: нет изменений в логике расчётов; заменён только импорт логгера
# (parallax_utils.logging_config -> loom.logging_config).
"""
