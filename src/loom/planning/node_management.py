...
# Original: src/scheduling/node_management.py — NodeManager (membership/lifecycle),
# Pipeline (фиксированные RR-пайплайны).
# Изменения: нет, скопировано as-is (переименованы только импорты под loom).
"""
