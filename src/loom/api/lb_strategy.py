...
# Original: src/router/lb_strategy.py — PerformanceStrategy, RandomStrategy,
# RoundRobinStrategy, make_strategy.
# Изменения: нет изменений в логике; скопировано as-is (без правок формул
# скоринга/выбора). Используется model-aware EndpointRegistry Loom.
"""
